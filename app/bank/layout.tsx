    ...
    <div className={cn(
      ...
      >
        ...
        <div className="flex items-center gap-3">
          {lastEvent ? (
            <span className={cn(
              "text-[10px] px-2.5 py-0.5 rounded-full font-semibold uppercase font-mono border",
        ...
        <div className="flex-1 p-4 overflow-y-auto font-mono text-[11px] text-slate-300 space-y-4">
          <div>
            ...
            <div className="bg-slate-900/60 p-2.5 rounded-lg border border-slate-800 space-y-1">
              ...
              <div><span className="text-indigo-400">Captured Events:</span> {precedingAssessments.length}</div>
            </div>
          </div>
            ...
            {lastEvent ? (
              <div className="space-y-2">
                ...
                <div className="space-y-1.5">
                  <div className="text-slate-500 uppercase text-[9px] font-bold">Risk Signals ({lastEvent.signals?.length || 0})</div>
